...
def get_tag(repo: Repo, commit: Commit) -> Optional[TagObject]:
...
def linkcode_resolve(domain, info):  # type: ignore[no-untyped-def]  # noqa: R701
    ...
    filename = relpath(fn, start=dirname(dirname(ampform.__file__)))
